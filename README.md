...
* [x] New preprocessor flag `NO_EXIT` (defined in NintendontVersion.h): prevents exiting the game (to avoid crashes on certain custom builds) - power button shus down the console
